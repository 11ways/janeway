module.exports = function defineLogList(Janeway, Blast, Bound) {
	...
	/**
	 * Handle a mousedown on the given lineIndex
	 *
	 * @author   Jelle De Loecker   <jelle@develry.be>
	 * @since    0.3.0
	 * @version  0.3.0
	 ...
	 * @param    {Number}   y           Absolute y position (`screen`)
	 */
	LogList.setMethod(function mouseDown(lineIndex, x, y) {
		// Mousedown listeners
	});

	/**
	 * Handle a mouseup on the given lineIndex
	 *
	 * @author   Jelle De Loecker   <jelle@develry.be>
	 * @since    0.3.0
	 * @version  0.3.0
	 ...
	 * @param    {Number}   y           Absolute y position (`screen`)
	 */
	LogList.setMethod(function mouseUp(lineIndex, x, y) {
		// Mouseup listeners
	});
