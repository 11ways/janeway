...
var nextTick = global.setImmediate || process.nextTick.bind(process),
    unicode  = require('blessed/lib/unicode'),
    helpers  = require('blessed/lib/helpers'),
    Input    = require('blessed/lib/widgets/input'),
...
Editarea.prototype._getMaxLine = function(lpos) {
	lpos = lpos ? lpos : this._getCoords();
...
Editarea.prototype._updateCursor = function(get, input) {
